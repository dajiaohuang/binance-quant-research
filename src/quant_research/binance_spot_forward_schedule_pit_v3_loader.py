...
BINDING_PATHS = {
    "wrapper": "src/quant_research/binance_spot_forward_schedule_pit_v3_wrapper.ps1",
    "collector": "src/quant_research/binance_spot_forward_schedule_pit_v3.py",
    "loader": "src/quant_research/binance_spot_forward_schedule_pit_v3_loader.py",
    "source_contract": "experiments/exp_20260826_010/artifacts/source_contract.json",
    "schema": "experiments/exp_20260826_010/artifacts/schema.json",
    "parameters": "experiments/exp_20260826_010/parameters.json",
    "tests": "tests/test_binance_spot_forward_schedule_pit_v3.py",
}
FLAG_ORDER = (
