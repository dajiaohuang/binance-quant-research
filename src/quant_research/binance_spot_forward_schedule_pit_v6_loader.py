...
BINDING_PATHS = {
    "wrapper": "src/quant_research/binance_spot_forward_schedule_pit_v6_wrapper.ps1",
    "collector": "src/quant_research/binance_spot_forward_schedule_pit_v6.py",
    "loader": "src/quant_research/binance_spot_forward_schedule_pit_v6_loader.py",
    "source_contract": "experiments/exp_20260827_003/artifacts/source_contract.json",
    "schema": "experiments/exp_20260827_003/artifacts/schema.json",
    "parameters": "experiments/exp_20260827_003/parameters.json",
    "tests": "tests/test_binance_spot_forward_schedule_pit_v6.py",
}
FLAG_ORDER = (
