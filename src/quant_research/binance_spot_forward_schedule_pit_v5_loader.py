...
BINDING_PATHS = {
    "wrapper": "src/quant_research/binance_spot_forward_schedule_pit_v5_wrapper.ps1",
    "collector": "src/quant_research/binance_spot_forward_schedule_pit_v5.py",
    "loader": "src/quant_research/binance_spot_forward_schedule_pit_v5_loader.py",
    "source_contract": "experiments/exp_20260827_002/artifacts/source_contract.json",
    "schema": "experiments/exp_20260827_002/artifacts/schema.json",
    "parameters": "experiments/exp_20260827_002/parameters.json",
    "tests": "tests/test_binance_spot_forward_schedule_pit_v5.py",
}
FLAG_ORDER = (
