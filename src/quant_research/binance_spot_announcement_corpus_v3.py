"""Freeze independent Binance CMS list/detail time claims without eligibility.
...
EXTRACTOR_VERSION = "binance_spot_announcement_v3"
...
REQUEST_HEADERS = {
    ...
    "Clienttype": "web",
    "lang": "en",
    "User-Agent": "quant-binance-announcement-corpus-v3/1",
}
...
def _source_contract() -> dict[str, Any]:
    return {
        ...
        "source_binding_rule": "self-contained extractor expected SHA-256 is verified before lease creation, immediately before every wire attempt, immediately after every returned response before evidence acceptance, and before artifact completion",
        "implementation_dependencies": "stdlib only; no v2 helper/runtime import",
