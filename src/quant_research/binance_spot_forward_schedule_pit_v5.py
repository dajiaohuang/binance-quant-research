...
EXPERIMENT_ID = "exp_20260827_002"
RUN_ID = "exp_20260827_002_formal_001"
VERSION = "binance_spot_forward_schedule_pit_v5"
SEMANTICS = (
...
BINDING_SPECS: tuple[tuple[str, str, str], ...] = (
    (
        ...
        "src/quant_research/binance_spot_forward_schedule_pit_v5_wrapper.ps1",
    ),
    (
        "--expected-collector-sha256", "collector",
        "src/quant_research/binance_spot_forward_schedule_pit_v5.py",
    ),
    (
        "--expected-loader-sha256", "loader",
        "src/quant_research/binance_spot_forward_schedule_pit_v5_loader.py",
    ),
    (
        "--expected-source-contract-sha256", "source_contract",
        "experiments/exp_20260827_002/artifacts/source_contract.json",
    ),
    (
        "--expected-schema-sha256", "schema",
        "experiments/exp_20260827_002/artifacts/schema.json",
    ),
    (
        "--expected-parameters-sha256", "parameters",
        "experiments/exp_20260827_002/parameters.json",
    ),
    (
        "--expected-tests-sha256", "tests",
        "tests/test_binance_spot_forward_schedule_pit_v5.py",
    ),
)
...
def formal_command(bindings: Mapping[str, Mapping[str, str]]) -> str:
    parts = [
        ...
        r"src\quant_research\binance_spot_forward_schedule_pit_v5_wrapper.ps1",
    ]
...
def _execute(
    ...
    try:
        ...
        import binance_spot_forward_schedule_pit_v5_loader as trusted_loader
