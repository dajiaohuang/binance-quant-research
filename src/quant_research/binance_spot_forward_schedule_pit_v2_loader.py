...
EXPERIMENT_ID = "exp_20260826_009"
RUN_ID = "exp_20260826_009_formal_001"
VERSION = "binance_spot_forward_schedule_pit_v2"
SEMANTICS = (
...
BINDING_PATHS = {
    "wrapper": "src/quant_research/binance_spot_forward_schedule_pit_v2_wrapper.ps1",
    "collector": "src/quant_research/binance_spot_forward_schedule_pit_v2.py",
    "loader": "src/quant_research/binance_spot_forward_schedule_pit_v2_loader.py",
    "source_contract": "experiments/exp_20260826_009/artifacts/source_contract.json",
    "schema": "experiments/exp_20260826_009/artifacts/schema.json",
    "parameters": "experiments/exp_20260826_009/parameters.json",
    "tests": "tests/test_binance_spot_forward_schedule_pit_v2.py",
}
FLAG_ORDER = (
...
def _formal_command_sha(bindings: Mapping[str, Mapping[str, str]]) -> str:
    parts = [
        ...
        r"src\quant_research\binance_spot_forward_schedule_pit_v2_wrapper.ps1",
    ]
