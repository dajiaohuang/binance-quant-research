...
CODE_BINDING_PATHS = {
    "runner": "src/quant_research/binance_spot_announcement_claims_lean_v1_runner.py",
    "extractor": "src/quant_research/binance_spot_announcement_claims_lean_v1.py",
    "loader": "src/quant_research/binance_spot_announcement_claims_lean_v1_loader.py",
    "source_contract": "experiments/exp_20260826_006/artifacts/source_contract.json",
    "schema": "experiments/exp_20260826_006/artifacts/schema.json",
    "parameters": "experiments/exp_20260826_006/parameters.json",
}
FLAG_ORDER = (
