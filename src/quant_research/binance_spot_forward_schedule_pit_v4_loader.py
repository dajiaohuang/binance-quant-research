...
BINDING_PATHS = {
    "wrapper": "src/quant_research/binance_spot_forward_schedule_pit_v4_wrapper.ps1",
    "collector": "src/quant_research/binance_spot_forward_schedule_pit_v4.py",
    "loader": "src/quant_research/binance_spot_forward_schedule_pit_v4_loader.py",
    "source_contract": "experiments/exp_20260827_001/artifacts/source_contract.json",
    "schema": "experiments/exp_20260827_001/artifacts/schema.json",
    "parameters": "experiments/exp_20260827_001/parameters.json",
    "tests": "tests/test_binance_spot_forward_schedule_pit_v4.py",
}
FLAG_ORDER = (
