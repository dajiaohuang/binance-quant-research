...
BINDING_SPECS: tuple[tuple[str, str, str], ...] = (
    (
        ...
        "src/quant_research/binance_spot_forward_schedule_pit_v1_wrapper.ps1",
    ),
    (
    ...
    (
        ...
        "src/quant_research/binance_spot_forward_schedule_pit_v1_loader.py",
    ),
    (
        "--expected-source-contract-sha256", "source_contract",
        "experiments/exp_20260826_008/artifacts/source_contract.json",
    ),
    (
        "--expected-schema-sha256", "schema",
        "experiments/exp_20260826_008/artifacts/schema.json",
    ),
    (
        "--expected-parameters-sha256", "parameters",
        "experiments/exp_20260826_008/parameters.json",
    ),
    (
        "--expected-tests-sha256", "tests",
        "tests/test_binance_spot_forward_schedule_pit_v1.py",
    ),
)
...
def _execute(
    ...
    try:
        ...
        import binance_spot_forward_schedule_pit_v1_loader as trusted_loader
