...
BINDING_SPECS: tuple[tuple[str, str, str], ...] = (
    (
        ...
        "src/quant_research/binance_spot_forward_schedule_pit_v2_wrapper.ps1",
    ),
    (
    ...
    (
        ...
        "src/quant_research/binance_spot_forward_schedule_pit_v2_loader.py",
    ),
    (
        "--expected-source-contract-sha256", "source_contract",
        "experiments/exp_20260826_009/artifacts/source_contract.json",
    ),
    (
        "--expected-schema-sha256", "schema",
        "experiments/exp_20260826_009/artifacts/schema.json",
    ),
    (
        "--expected-parameters-sha256", "parameters",
        "experiments/exp_20260826_009/parameters.json",
    ),
    (
        "--expected-tests-sha256", "tests",
        "tests/test_binance_spot_forward_schedule_pit_v2.py",
    ),
)
...
def _execute(
    ...
    try:
        ...
        import binance_spot_forward_schedule_pit_v2_loader as trusted_loader
