...
from quant_research.binance_spot_announcement_corpus_v2 import (
    DETAIL_BASE,
    LIST_BASE,
    REQUEST_HEADERS,
    TIME_URL,
...
class AnnouncementCorpusV2Tests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_v2_extractor_is_self_contained(self) -> None:
    ...
    def test_bounded_default_reader_uses_cap_plus_one_and_oversize_is_terminal(self) -> None:
        ...
        with mock.patch(
            "quant_research.binance_spot_announcement_corpus_v2.urllib.request.build_opener",
            return_value=opener,
        ) as builder:
    ...
    def test_extractor_drift_after_lease_stops_before_first_get(self) -> None:
        ...
        fetcher = CmsFetcher(self.catalogs)
        with mock.patch(
            "quant_research.binance_spot_announcement_corpus_v2._module_sha",
